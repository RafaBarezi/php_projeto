...
int main()
{
    ...
    //Vamos simular as notas e confirmar se foi aprovado ou não! Primeiro declaramos as variáveis:
    float nota1, nota2, nota3, nota4, media;
    //Aqui igualamos as variáveis a 0:
    ...
    // agora é só somar elas e dividir por 4:
    media=(nota1 + nota2 + nota3 + nota4)/4;
    printf("\nO valor da sua media escolar foi de : %.0f\n", media);
    // Atenção : observe que %.0f\n não permitiu mostrar decimal no float.
